...
class Trainer(object):
            ...
            if (itera + 1) % 1 == 0:
                ...
                if (itera + 1) % 500 == 0:
                    ...
                    if mIoU_val > best_mIoU:
                        ...
                        print('best round is ', best_round)
    ...
    def validation(self):
        ...
        print("---------Validation loop finished-----------") # Move this print to AFTER the loop
    ...
    def test(self):
        ...
        # vbar = tqdm(val_data_loader, ncols=50)
        with torch.no_grad():
            # 1. Wrap the DataLoader with tqdm and add a descriptive label
            progress_bar = tqdm(val_data_loader, desc="Testing")

            # 2. Loop over the new progress_bar object
            #    (We don't need enumerate here unless you specifically use 'itera' later)
